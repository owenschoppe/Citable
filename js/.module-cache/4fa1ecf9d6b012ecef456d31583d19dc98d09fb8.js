...
var DocSelectControl = React.createClass({displayName: 'DocSelectControl',
	...
	render: function(){
	    ...
	    for (var i in this.props.docs) {
	    	...
	    	children.push(React.DOM.option( {key:doc, value:doc.alternateLink}, doc.title));
	    }
	    console.log(this.props.handleChange);
	    return (
	    	React.DOM.select( {className:"Droid destination", name:"destination", onChange:this.props.handleChange(this)}, 
