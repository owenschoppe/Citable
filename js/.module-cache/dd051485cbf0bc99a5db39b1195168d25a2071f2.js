...
var DocSelectControl = React.createClass({displayName: 'DocSelectControl',
	...
	handleChange: function(event){
		console.log('New Doc Selected:',event,event);
		this.props.changeDestination(event);
	...
	render: function(){
	    ...
	    return (
	    	React.DOM.select( {className:"Droid destination", name:"destination", onChange:this.handleChange(event)}, 
    ...
    return (
        React.DOM.div(null, 
			...
			React.DOM.div( {className:"space selection", name:"selection"}, 
				...
				DocSelectControl( {docs:this.props.docs, changeDestination:this.changeDestination})
			),
