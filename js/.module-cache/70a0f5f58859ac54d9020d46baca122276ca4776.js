...
var DocSelectControl = React.createClass({displayName: 'DocSelectControl',
	...
	render: function(){
	    ...
	    return (
	    	React.DOM.select( {className:"Droid destination", name:"destination", onChange:this.handleChange, defaultValue:this.props.docs.length&&i==0?this.props.docs[0].alternateLink:'new'}, 
