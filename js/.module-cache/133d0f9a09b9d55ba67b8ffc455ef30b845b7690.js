...
var DocSelectControl = React.createClass({displayName: 'DocSelectControl',
	...
	render: function(){
	    ...
	    return (
	    	React.DOM.select( {className:"Droid destination", name:"destination", onChange:this.props.handleChanges(this.value)}, 
    ...
    return (
        React.DOM.div(null, 
			...
			React.DOM.div( {className:"space selection", name:"selection"}, 
				...
				DocSelectControl( {docs:this.props.docs, handleChanges:this.handleChange})
			),
