...
var DocSelectControl = React.createClass({displayName: 'DocSelectControl',
	...
	render: function(){
	    ...
	    return (
	    	React.DOM.select( {className:"Droid destination", name:"destination", onChange:this.handleChange.bind(this)}, 
...
var Controls = React.createClass({displayName: 'Controls',
	render: function(){
		return (
			React.DOM.div(null, 
				React.DOM.div(null, DocSelectControl.state.destination),
